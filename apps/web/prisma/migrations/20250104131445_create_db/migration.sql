...
CREATE TABLE "Project" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "usageCheckedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "Project_externalReferenceId_key" ON "Project"("externalReferenceId");

-- CreateIndex
CREATE INDEX "Project_usageCheckedAt_idx" ON "Project"("usageCheckedAt" ASC);
